...
class AppointmentAdapter(private val dentalAppointmentsList: ArrayList<DentalAppointment>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val dentist = itemView.findViewById<TextView>(R.id.txtDentist)
        val clinic = itemView.findViewById<TextView>(R.id.txtClinic)
        val service = itemView.findViewById<TextView>(R.id.txtService)
    }
}